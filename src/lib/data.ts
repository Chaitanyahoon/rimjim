export const rimjimData = {
  ...
  about: {
    title: "Canon Lore",
    traits: [
      { id: 1, text: "Runs on 90% caffeine and 10% anxiety", icon: "☕" },
      { id: 2, text: "Professional overthinker (Gold Medalist)", icon: "🤔" },
      { id: 3, text: "Can listen to the same song for 7 hours straight", icon: "🎧" },
      { id: 4, text: "Fluent in movie references and sarcasm", icon: "🎬" },
      { id: 5, text: "Probably awake right now", icon: "🦉" }
    ]
  },
  moments: [
    { id: 1, text: "That time we laughed until we couldn't breathe at 3 AM" },
    { id: 2, text: "The impromptu road trip that changed everything" },
  ...
  tinyThings: [
    ...
    { id: 3, text: "That one hoodie you live in", emoji: "🧥" },
    { id: 4, text: "Sending memes instead of typing", emoji: "📱" }
  ],
  birthday: {
    title: "It's Rimjim Day 🎉",
    hiddenMessage: "Another year around the sun. Keep shining, you chaos star. Wish or not — you're already enough."
  },
  roasts: [
